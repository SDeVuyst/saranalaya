    ...
    if request.method == "POST":
        ...
        for possible_ticket in possible_tickets:
            ...
            if amount_of_tickets is not None:
                tickets[possible_ticket.pk] = int(amount_of_tickets)
        ...
        total_cost = sum([ticket.price.amount for i, ticket in tickets.items()])
        ...
        for ticket_id, amount in tickets.items():
...
def payment_success(request, payment_id):
    ...
    return TemplateResponse(request, "paymentcallback.html", {"title": "Betaling geslaagd!"})


def payment_failure(request, payment_id):
    return TemplateResponse(request, "paymentcallback.html", {"title": "Oeps, er ging iets mis!"})